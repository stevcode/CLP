...
namespace CLP.CustomControls
{
    ...
    public class HLSColorValueConverter : IValueConverter
    {
        #region Structs
        ...
        /// <summary>Adjusts an RGB color by a specified percentage.</summary>
        ...
        /// <summary>Not implemented in this converter; will throw an exception if called.</summary>
        ...
        /// <summary>Converts a WPF RGB color to an HSL color</summary>
        ...
        /// <summary>Converts a WPF HSL color to an RGB color</summary>
        ...
        /// <summary>Used by the HSL-to-RGB converter.</summary>
