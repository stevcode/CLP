...
namespace CLP.Models
{
    ...
    public class CLPStamp : DataObjectBase<CLPStamp>, ICLPPageObject
    {
        ...
        public void AcceptStrokes(List<string> addedStrokes, List<string> removedStrokes)
        {
            ...
            Rect rectContainer = new Rect(StrokePathContainer.XPosition, StrokePathContainer.YPosition,
        ...
        public void AcceptObjects(List<string> addedPageObjectIDs, List<string> removedPageObjectIDs)
        {
            if(CanAcceptPageObjects)
            {
                ...
                var pageObjectsRemove =
                    from pageObjectID in removedPageObjectIDs
                ...
                var pageObjectsAdd =
                    ...
                    where (pageObject.UniqueID).Equals(pageObjectID)
                    select pageObject;
                if (addedPageObjectIDs.Count > 0 && !PartsAutoGenerated)
                    {
                        Console.WriteLine("acceptObject and update interpretation");
                        UpdatePartsFromHandwritingRegion();
