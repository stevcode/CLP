...
namespace CLP.Models
{
    ...
    public class CLPFFCComputationDisplay : CLPArray
    {
        ...
        public CLPFFCComputationDisplay(int rows, int columns, int dividend, ICLPPage page)
        ...
        protected CLPFFCComputationDisplay(SerializationInfo info, StreamingContext context)
            : base(info, context) { }
        ...
        public override string PageObjectType
        {
            get
            {
                return "CLPFFCComputationDisplay";
            }
        }
        ...
        public ObservableCollection<string> ComputationStrings
        {
            get
            {
        ...
        {
            var newArray = Clone() as CLPFFCComputationDisplay;
            if(newArray != null)
            {
