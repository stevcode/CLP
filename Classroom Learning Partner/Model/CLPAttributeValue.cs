...
{
    //OBSOLETE - REMOVE WHEN ALL CONVERSIONS ARE MADE
    [Serializable]
    public class CLPAttributeValue : DataObjectBase<CLPAttributeValue>
    {
        public CLPAttributeValue()
        {
        ...
        protected CLPAttributeValue(SerializationInfo info, StreamingContext context)
            : base(info, context) { }
