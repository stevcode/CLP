...
namespace Classroom_Learning_Partner.ViewModels
{
    ...
    public class StampViewModel : APageObjectBaseViewModel
    {
        ...
        private void OnShowKeyPadCommandExecute()
        {
            ...
            stamp.Parts = parts;
            ACLPPageBaseViewModel.AddHistoryItemToPage(stamp.ParentPage, new PartsValueChangedHistoryAction(stamp.ParentPage, App.MainWindowViewModel.CurrentUser, stamp.ID, oldPartsValue, parts));
