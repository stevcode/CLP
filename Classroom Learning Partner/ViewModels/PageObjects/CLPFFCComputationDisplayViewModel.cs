...
{
    public class CLPFFCComputationDisplayViewModel : CLPArrayViewModel
    {

        #region Constructor

        /// <summary>
        /// Initializes a new instance of the <see cref="CLPFFCComputationDisplayViewModel"/> class.
        /// </summary>
        public CLPFFCComputationDisplayViewModel(CLPFFCComputationDisplay factorCard)
            : base(factorCard)
        {
        ...
        {
            var clpArray = PageObject as CLPFFCComputationDisplay;
            if(clpArray == null)
            {
                return;
            }
        ...
        /// </summary>
        public Command RemoveLastArrayCommand
        {
            get;
            private set;
        }
        ...
        {
            (PageObject as CLPFFCComputationDisplay).RemoveLastDivision();
        }
