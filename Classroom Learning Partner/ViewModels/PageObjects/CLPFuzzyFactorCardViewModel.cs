...
{
    public class CLPFuzzyFactorCardViewModel : APageObjectBaseViewModel// : CLPArrayViewModel
    {
        ...
        /// </summary>
        public CLPFuzzyFactorCardViewModel(FuzzyFactorCard factorCard) //: base(factorCard)
        {
