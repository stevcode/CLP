...
namespace Classroom_Learning_Partner.ViewModels
{
    ...
    public abstract class ACLPPageBaseViewModel : ViewModelBase
    {
        ...
        public static void AddHistoryItemToPage(CLPPage page, IHistoryItem historyItem, bool isBatch = false)
        {
            ...
            if(MainWindowViewModel.CurrentProgramMode != App.UserMode.Instructor || App.Network.ProjectorProxy == null || App.MainWindowViewModel.Ribbon.IsBroadcastHistoryDisabled)
            {
                return;
            }
