...
namespace CLP.Entities
{
    ...
    public class MultipleChoiceBubbleStatusChangedHistoryAction : AHistoryActionBase
    {
        ...
        /// <summary>Initializes <see cref="MultipleChoiceBubbleStatusChangedHistoryAction" /> from scratch.</summary>
        public MultipleChoiceBubbleStatusChangedHistoryAction() { }

        /// <summary>Initializes <see cref="MultipleChoiceBubbleStatusChangedHistoryAction" /> with a parent <see cref="CLPPage" />.</summary>
