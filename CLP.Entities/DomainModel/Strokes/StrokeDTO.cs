...
namespace CLP.Entities
{
    ...
    public class StrokeDTO
    {
        ...
        /// <summary>Initializes <see cref="StrokeDTO" /> from scratch.</summary>
        public StrokeDTO() { }
        ...
        /// <summary>Unique Identifier of the <see cref="StrokeDTO" />.</summary>
        public string ID { get; set; }

        /// <summary>Unique Identifier of the <see cref="Person" /> that made the <see cref="StrokeDTO" />.</summary>
        public string PersonID { get; set; }

        /// <summary>Height of the <see cref="StrokeDTO" /> tip.</summary>
        public double Height { get; set; }

        /// <summary>Width of the <see cref="StrokeDTO" /> tip.</summary>
        public double Width { get; set; }

        /// <summary>Signifies <see cref="StrokeDTO" /> is translucent.</summary>
        public bool IsHighlighter { get; set; }

        /// <summary>Signifies the <see cref="StrokeDTO" /> is using Beizer Curves for smoothing.</summary>
        public bool FitToCurve { get; set; }

        /// <summary>Signifies the <see cref="StrokeDTO" /> is not using pressure information.</summary>
        public bool IgnorePressure { get; set; }

        /// <summary>Color of the <see cref="StrokeDTO" />.</summary>
        ...
        /// <summary>
        ///     List of all the points that make up a <see cref="StrokeDTO" />. Entire list stored as a string because individual points do not need to be inserted into the database. Points are delimited by
        ///     a ','. Each individual point is a group whose parts are delimited by a ':', in the form of X:Y:PressureFactor. The Types of those parts are double:double:float, respectively.
        /// </summary>
        ...
        public Stroke ToStroke()
        {
            ...
            drawingAttributes.Color = (Color?)convertFromString ?? Colors.Black;
