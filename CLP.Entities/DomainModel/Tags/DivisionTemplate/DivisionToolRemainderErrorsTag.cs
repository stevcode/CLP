...
{
    [Serializable]
    public class DivisionToolRemainderErrorsTag : ADivisionToolBaseTag
    {
        #region Constructors

        /// <summary>Initializes <see cref="DivisionToolRemainderErrorsTag" /> from scratch.</summary>
        public DivisionToolRemainderErrorsTag() { }

        /// <summary>Initializes <see cref="DivisionToolRemainderErrorsTag" />.</summary>
        /// <param name="parentPage">The <see cref="CLPPage" /> the <see cref="DivisionToolRemainderErrorsTag" /> belongs to.</param>
        public DivisionToolRemainderErrorsTag(CLPPage parentPage, Origin origin, string divisionToolID, double dividend, double divisor, int divisionToolNumber)
            : base(parentPage, origin, divisionToolID, dividend, divisor, divisionToolNumber) { }

        /// <summary>Initializes <see cref="DivisionToolRemainderErrorsTag" /> based on <see cref="SerializationInfo" />.</summary>
        /// <param name="info"><see cref="SerializationInfo" /> that contains the information.</param>
        /// <param name="context"><see cref="StreamingContext" />.</param>
        public DivisionToolRemainderErrorsTag(SerializationInfo info, StreamingContext context)
            : base(info, context) { }
        ...
        public override string FormattedName
        {
            get
            {
                return string.Format("Division Template {0} Remainder Errors{1}", DivisionToolNumber, HadTrouble ? " **Trouble**" : string.Empty);
            }
        }
