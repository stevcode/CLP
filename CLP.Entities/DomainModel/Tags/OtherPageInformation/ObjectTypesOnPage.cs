...
namespace CLP.Entities
{
    ...
    public class ObjectTypesOnPage : ATagBase
    {
        ...
        /// <summary>Initializes <see cref="ObjectTypesOnPage" /> from scratch.</summary>
        public ObjectTypesOnPage() { }

        /// <summary>Initializes <see cref="ObjectTypesOnPage" /> from values.</summary>
        ...
        /// <summary>Initializes <see cref="ObjectTypesOnPage" /> based on <see cref="SerializationInfo" />.</summary>
